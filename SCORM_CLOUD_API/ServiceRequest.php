	 ...
	 /// <summary>
        ...
        private static function AssertNoErrorAndReturnXml($xmlString)
        {
			...
			if($rspElements["stat"]!='ok')
			{
				...
				{
					error_log("SCORM Cloud Error : ".$rspElements->err["code"]." - ".$rspElements->err["msg"] );
				}else{
					error_log("Invalid XML Response from web service call, expected <rsp> tag, instead received: ".$xmlString);
				}
			}
